 ...
 *
 * 종료는 ESC/⏸ → TutorialPauseModal → 스킵 경로로 일원화.
 */
  ...
  if (state.phase === 'description') {
    return (
      <>
        ...
        <div className="font-pixel absolute top-3 left-game-sidebar w-game-center z-40 tutorial-bubble-wrap pointer-events-none">
