...
@Entity
@Table(
    name = "competitive_command_set_item",
    uniqueConstraints = {
        @UniqueConstraint(name = "uq_competitive_command_set_item",
            columnNames = {"competitive_command_set_id", "sequence"})
    }
)
public class CompetitiveCommandSetItem {
    ...
    @Column(name = "competitive_command_set_item_id", nullable = false,
