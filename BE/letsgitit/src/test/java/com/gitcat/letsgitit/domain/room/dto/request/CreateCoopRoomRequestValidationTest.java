...
class CreateCoopRoomRequestValidationTest {
	...
	private Set<ConstraintViolation<CreateCoopRoomRequest>> validate(String teamName) {
		return validator.validate(new CreateCoopRoomRequest("방 제목", teamName, false, null, UUID.randomUUID()));
	}
	...
	@Test
	void 숫자가_포함된_팀_이름은_검증을_통과한다() {
		assertThat(validate("Team1")).isEmpty();
	}
